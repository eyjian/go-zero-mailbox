...
type ListMessagesReq struct {
	...
	Recipient  string                     `protobuf:"bytes,1,opt,name=recipient,proto3" json:"recipient,omitempty"`                                                                    // 收件人
	PageStart  string                     `protobuf:"bytes,2,opt,name=page_start,json=pageStart,proto3" json:"page_start,omitempty"`                                                   // 起始页，值为空表示首页
	PageSize   string                     `protobuf:"bytes,3,opt,name=page_size,json=pageSize,proto3" json:"page_size,omitempty"`                                                      // 页大小，默认为 10
...
func (x *ListMessagesReq) GetPageStart() string {
	if x != nil {
		return x.PageStart
	}
	return ""
...
func (x *ListMessagesReq) GetPageSize() string {
	if x != nil {
		return x.PageSize
	}
	return ""
...
var file_mooon_mailbox_proto_rawDesc = []byte{
	...
	0x70, 0x61, 0x67, 0x65, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52,
